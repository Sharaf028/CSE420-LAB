...
%token IF ELSE FOR INT CONST_INT FLOAT CONST_FLOAT WHILE DO CONTINUE BREAK CHAR DOUBLE CASE VOID SWITCH DEFAULT GOTO RETURN PRINTLN ADDOP MULOP INCOP DECOP RELOP ASSIGNOP LOGICOP NOT LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD COMMA COLON SEMICOLON ID
...
statement : variable_decl
    ...
    outlog<<"println("<<$3->getnameofsymbol()<<");"<<endl<<endl;

    $$ = new symbol_info("println("+$3->getnameofsymbol()+");","statement");
    }
