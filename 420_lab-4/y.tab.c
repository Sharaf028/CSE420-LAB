...
static const yytype_uint16 yyrline[] =
{
    ...
    1121,  1195,  1204,  1216,  1228,  1245,  1264,  1272,  1283,  1306
};
#endif
...
#line 1229 "22201563_22299135.y"
    {
		...
		VarNode* readNode = new VarNode(varNode->get_name(), (yyvsp[(1) - (2)])->getvartype());
