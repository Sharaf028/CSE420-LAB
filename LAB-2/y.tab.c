...
{
       0,    56,    56,    65,    72,    81,    88,    98,    97,   124,
     123,   145,   164,   174,   184,   194,   206,   215,   225,   258,
     266,   274,   282,   292,   300,   308,   316,   327,   334,   343,
     350,   358,   365,   372,   379,   386,   393,   400,   407,   416,
     423,   432,   440,   449,   456,   465,   472,   481,   488,   497,
     505,   514,   522,   532,   539,   546,   554,   560,   567,   574,
     581,   588,   595,   602,   611,   619,   627,   634
};
#endif
...
#line 98 "22201563_22299135.y"
    {
			...
			{
				outlog<<"Error at line "<<lines<<": Multiple declaration of function "<<(yyvsp[(2) - (5)])->getname()<<endl<<endl;
			}
		}
    break;
...
#line 124 "22201563_22299135.y"
    {
			...
			if(!symbt_table->insert(func))
			{
				outlog<<"Error at line "<<lines<<": Multiple declaration of function "<<(yyvsp[(2) - (4)])->getname()<<endl<<endl;
			}
		}
    break;
